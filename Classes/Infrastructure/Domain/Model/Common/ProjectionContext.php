<?php
namespace TYPO3\CMS\EventSourcing\Infrastructure\Domain\Model\Common;
...
class ProjectionContext implements Instantiable, Providable, RepresentableAsLocalStorageName
{
    ...
    public static function provide(
        \TYPO3\CMS\EventSourcing\Core\Domain\Model\Common\bool $force = false)
    {
    ...
    public static function asString(
        \TYPO3\CMS\EventSourcing\Core\Domain\Model\Common\int $workspaceId, array $languageChain = [])
    {
     ...
     * @return ProjectionContext
     */
    public function setWorkspaceId(
        \TYPO3\CMS\EventSourcing\Core\Domain\Model\Common\int $workspaceId)
    {
        $this->handleLock();
